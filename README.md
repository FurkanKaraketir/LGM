...
**Download:** [v0.2.5](https://github.com/FurkanKaraketir/LGM/releases/tag/v0.2.5) — Windows installer or portable zip, macOS `.dmg` or portable zip, Linux AppImage.
...
Tagged releases (`v0.2.5` is the latest) are built for Windows, macOS, and Linux via GitHub Actions and published on [GitHub Releases](https://github.com/FurkanKaraketir/LGM/releases).
